...
namespace DBTBalanceRevivedLSSJ4Fix.Model;
...
public class BuffLayer : PlayerDrawLayer
{
    ...
    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
        ...
        if (player.LSSJ4Active && BalanceConfig.Instance.UseHair)
        {
            ...
            DrawData dataBody = new(ModContent.Request<Texture2D>("DBTBalanceRevivedLSSJ4Fix/Assets/LSSJ4Body", AssetRequestMode.AsyncLoad).Value,
            ...
            DrawData dataArms = new(ModContent.Request<Texture2D>("DBTBalanceRevivedLSSJ4Fix/Assets/LSSJ4Arms", AssetRequestMode.AsyncLoad).Value,
