using DBTBalanceRevivedLSSJ4Fix.Buffs;
...
public class BPlayer : ModPlayer
{
    ...
    {
        if (LSSJ4Achieved)
            tag.Add("DBTBalanceRevivedLSSJ4Fix_LSSJ4Achieved", LSSJ4Achieved);
        if (LSSJ4UnlockMsg)
            tag.Add("DBTBalanceRevivedLSSJ4Fix_LSSJ4UnlockMsg", LSSJ4UnlockMsg);
    }
    public override void LoadData(TagCompound tag)
    {
        LSSJ4Achieved = tag.ContainsKey("DBTBalanceRevivedLSSJ4Fix_LSSJ4Achieved");
        LSSJ4UnlockMsg = tag.ContainsKey("DBTBalanceRevivedLSSJ4Fix_LSSJ4UnlockMsg");
    }
    ...
    public override void PostUpdate()
    {
        ...
        if (LSSJ4Achieved && !LSSJ4UnlockMsg)
        {
            ...
            {
                Main.NewText(Language.GetText("Mods.DBTBalanceRevivedLSSJ4Fix.Misc.LSSJ4Unlocked"), Color.Green);
